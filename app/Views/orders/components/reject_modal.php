            ...
            <form action="<?= $baseUrl ?>/index.php?page=reject_old_price" method="POST">
                ...
                <div class="modal-header border-bottom-0 pb-0 pt-4 px-4 position-relative">
                    <div class="d-flex align-items-center mb-2">
                        <div class="bg-danger bg-opacity-10 text-danger rounded-circle d-flex justify-content-center align-items-center me-3 icon-box-lg">
                ...
                <div class="modal-body px-4 pt-3 pb-4">
                    <div class="bg-light rounded p-3 mb-3 border alert-warning-custom">
                    ...
                    <div>
                        ...
                        <textarea class="form-control bg-light custom-textarea" id="rejectReason" name="reject_reason" rows="3" required placeholder="Ví dụ: Bảng giá tháng 4 đã hết hiệu lực, vui lòng cập nhật báo giá mới..."></textarea>
                    </div>
                </div>
